import { is as t, zo as n } from "./app-server-manager-signals-7MlBpIlX.js";
import { s as e } from "./chunk-Bj-mKKzh.js";
import { t as a } from "./clsx-DDuZWq6Y.js";
import { t as l } from "./codex-avatar-Cd11w_1c.js";
import { n as r, t as i } from "./jsx-runtime-CiQ1k8xo.js";
import { t as s } from "./proxy-HwxlKevX.js";
import { xt as o } from "./setting-storage-kJblH-wH.js";
import { t as c } from "./use-reduced-motion-DwzvbwaT.js";
var u = o(),
  d = e(r(), 1),
  f = i(),
  p = 4,
  ...
  h = n(`avatar-mascot-notification-badge-corner`, `top-end`);
function g(e) {
  let t = (0, u.c)(23),
    {
      ariaLabel: n,
...
function _(e) {
  ...
  n[2] === o
    ...
    : ((T = (e) => {
        ...
        if (
          ...
          (t != null &&
            o(v({ avatarBounds: t, clientX: e.clientX, clientY: e.clientY })),
            g(null),
            e.preventDefault(),
            (y.current = !0),
            window.setTimeout(() => {
  ...
  n[8] === Symbol.for(`react.memo_cache_sentinel`)
    ? ((N = { opacity: 1, scale: 1, y: 0 }), (n[8] = N))
    : (N = n[8]);
  let P = r.ariaLabel,
    F = m[i],
    I = r.isIconOnly ? `size-7 p-0` : `min-h-7 min-w-7 px-2 py-1`,
    L;
  n[9] !== I || n[10] !== F
    ? ((L = a(
  ...
  let V = l == null ? void 0 : `${l.x}px ${l.y}px`,
    H;
  n[15] !== r.backgroundColor || n[16] !== r.foregroundColor || n[17] !== V
    ? ((H = {
        backgroundColor: r.backgroundColor,
        color: r.foregroundColor,
        translate: V,
      }),
      (n[15] = r.backgroundColor),
      (n[16] = r.foregroundColor),
      (n[17] = V),
      (n[18] = H))
    : (H = n[18]);
  let U, W;
  ...
  n[22] === b
    ? (G = n[23])
    : ((G = b ? void 0 : { scale: 0.94 }), (n[22] = b), (n[23] = G));
  let K;
  return (
    n[24] !== M ||
    n[25] !== E ||
...
export { g as t };
//# sourceMappingURL=avatar-mascot-button-CS8RntF9.js.map
